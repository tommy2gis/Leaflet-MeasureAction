...
L.Map.addInitHook(function () {
    ...
    GEOS.namespace = function(ns, context) {
        ...
        for (var i = 0; i < num; ++i) {
            ...
            if (parts.length > 0) {
                GEOS.namespace([parts.join('.')], context[base]);
            }
        }
    };
    GEOS.Class = function() {
        ...
        if (len > 1) {
            ...
            GEOS.inherit.apply(null, newArgs);
        } else {
            C.prototype = F;
        }
        return C;
    };
    GEOS.extend = function(destination, source) {
...
GEOS.Widget = GEOS.Class({
        ...
        isOpen: false, // whether or not widget is displayed in applicable module view
        isMinimized: false,
        ...
        initialize: function(id, owner, options) {
          ...
          //  this.owner = owner;
           ...
           // this.owner.addWidget(this);
            ...
            this.mainDiv = $('<div />').attr('id', id).addClass('DCI-widget').appendTo('body');
            if (!this.transparent) this.mainDiv.addClass('DCI-widget-nonTransparent');
        ...
        addHeader: function() {
            var this_ = this;
            //this.title = title;
            this.header = $('<div class="DCI-widget-header">' + this.title + '</div>').appendTo(this.mainDiv);
            var buttons = $('<div class="DCI-widget-header-buttons"></div>').appendTo(this.mainDiv);

            if (this.closeable) {
                $("<div class='DCI-widget-header-button'>×<div>").appendTo(buttons)
                    .click(function(evt) {
                        evt.preventDefault();
                        this_.close();
                    });
           ...
           /* // set up context menu
            this.contextMenu = new DCI.core.ContextMenu(this.mainDiv, function() {
        ...
        minimize: function() {
            var this_ = this;
            this.hide();
            this.minimizedTab = $('<div class="DCI-minimized-tab">' + this.title + '</div>')
                .appendTo($('#DCI-minimize-tray'))
                .click(function() {
                    this_.unminimize();
                });
        ...
        setContent: function(htmlContent) {
            $('<div class="DCI-widget-header-content"/>').html(htmlContent).appendTo(this.mainDiv);
        },
